              ...
              <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-6">
                ...
                <form onSubmit={handleAddBus} className="grid grid-cols-1 md:grid-cols-3 gap-4 items-end">
                  ...
                  <div>
                    ...
                    <input type="number" required value={newBus.price} onChange={(e) => setNewBus({...newBus, price: e.target.value})} className="w-full px-3 py-2 border rounded-lg" placeholder="50" />
                  </div>
